...
<html>
  <head>
    ...
    <title>ITVentasSP | www.apoloinstrumentos.com.ar</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>ITVentasSP</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Lic. Gustavo Paszco</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.apoloinstrumentos.com.ar - Lic. Paszco - Software
                      <small>www.youtube.com/paszco</small>
                    </p>
                  </li>
